...
use bevy::prelude::*;
use colliders::*;
use prelude::ContactEvent;
use rigid_body::*;
use manifold::*;
use intersect::*;
pub mod prelude {
    pub use crate::{colliders::*, constraints::*, contact::*, rigid_body::*, PhysicsPlugin};
}
...
impl Plugin for PhysicsPlugin {
    fn build(&self, app: &mut App) {
        app.add_system(
            apply_gravity.label(PhysicsSystem::ApplyGravity));
        app.add_system(
            colision_detection
...
fn apply_gravity(config: Res<PhysicsResource>, time: Res<Time>, mut query: Query<&mut RigidBody>) {
